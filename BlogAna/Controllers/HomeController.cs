    ...
    public IActionResult Index()
    {
        ...
        List<Postagem> postagens = [
            ...
            new(){
                ...
                Descricao = "Novidades",
                Texto = "Meio Ambiente",
                Thumbnail = " Há um movimento crescente para tornar a mineração de criptomoedas mais sustentável. Novas tecnologias e iniciativas estão surgindo para reduzir o consumo de energia e a pegada de carbono, o que é um tema importante para o futuro da blockchain.",
                Foto = "/img/"
            },
             new(){
                Id = 3,
